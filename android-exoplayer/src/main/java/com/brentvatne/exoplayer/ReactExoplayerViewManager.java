...
public class ReactExoplayerViewManager extends ViewGroupManager<ReactExoplayerView> {
    ...
    private static final String PROP_SRC_EXTERNAL_SUBTITLE_URL = "externalSubtitleUrl";
    ...
    public void setSrc(final ReactExoplayerView videoView, @Nullable ReadableMap src) {
        ...
        String externalSubtitleUrl = src.hasKey(PROP_SRC_EXTERNAL_SUBTITLE_URL) ? src.getString(PROP_SRC_EXTERNAL_SUBTITLE_URL) : null;
        ...
        if (!TextUtils.isEmpty(externalSubtitleUrl)) {
            videoView.setExternalSubtitleUrl(Uri.parse(externalSubtitleUrl));
        }
